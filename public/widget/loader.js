(function () {
  try {
    ...
    iframe.style.cssText = [
      ...
      'border:0','margin:0','padding:0','z-index:2147483647',
    ...
    function inject() {
      ...
      if (html) {
        var prev = html.style.scrollPaddingTop;
        html.style.scrollPaddingTop = '36px';
        if (!prev && document.body) {
          document.body.style.marginTop = (parseInt(getComputedStyle(document.body).marginTop) || 0) + 36 + 'px';
        }
      }
    }
